...
if(lock("remove-"+phone)) return alert("⏳ Traitement...");

try{

if(!phone) throw "❌ Numéro invalide";
...
if(lock("add-"+phone)) return alert("⏳ Traitement...");
...
if(lock("del-"+phone)) return alert("⏳ Traitement...");
